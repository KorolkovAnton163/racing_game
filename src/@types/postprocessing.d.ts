declare module "postprocessing" {
	...
	export class KawaseBlurMaterial extends ShaderMaterial implements Resizable {
		 ...
		 */
		getKernel(): Float32Array<ArrayBufferLike>;
	...
	export class Effect
		 ...
		 * @experimental
		 */
		public get inputColorSpace(): ColorSpace;
		/**
		 * @type {ColorSpace}
		 * @protected
		 * @experimental
		 */
		public set inputColorSpace(arg: ColorSpace);
		/**
		 ...
		 * @experimental
		 */
		public get outputColorSpace(): ColorSpace;
		/**
		 * @type {ColorSpace}
		 * @protected
		 * @experimental
		 */
		public set outputColorSpace(arg: ColorSpace);
		/**
		 * Sets the main scene.
		 *
		 * @type {Scene}
	...
	export class RawImageData implements ImageData {
		 ...
		 */
		constructor(width?: number, height?: number, data?: Uint8ClampedArray<ArrayBufferLike>);
