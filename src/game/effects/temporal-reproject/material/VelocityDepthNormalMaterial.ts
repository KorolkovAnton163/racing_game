...
export const velocity_uniforms = {
  prevVelocityMatrix: { value: new THREE.Matrix4() },
  velocityMatrix: { value: new THREE.Matrix4() },
...
export default class VelocityDepthNormalMaterial extends THREE.ShaderMaterial {
