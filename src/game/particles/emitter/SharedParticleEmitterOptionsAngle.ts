...
export interface SharedParticleEmitterOptionsAngleInterface {
    value: number | number[];
    spread: number | number[];
    randomise: boolean;
}

export class SharedParticleEmitterAngle extends SharedParticleEmitterProperty {
    protected readonly FLAG: string = 'angle';
    ...
    constructor(data: SharedParticleEmitterOptionsAngleInterface) {
        super();
