...
export interface SharedParticleEmitterOptionsVelocityInterface {
    value: THREE.Vector3;
...
export class SharedParticleEmitterVelocity extends SharedParticleEmitterProperty {
    protected readonly FLAG: string = 'velocity';
    ...
    constructor(data: SharedParticleEmitterOptionsVelocityInterface) {
        super();
