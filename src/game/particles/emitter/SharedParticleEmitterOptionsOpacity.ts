...
export interface SharedParticleEmitterOptionsOpacityInterface {
    value: number | number[];
    spread: number | number[];
    randomise: boolean;
}

export class SharedParticleEmitterOpacity extends SharedParticleEmitterProperty {
    ...
    constructor(data: SharedParticleEmitterOptionsOpacityInterface) {
        super();
